  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-gray-500 mb-6">Please fill out the form below. Your details will be sent directly to Typeform.</p>
        {completed ? (
          ...
          <div className="w-full h-[600px]">
            <iframe
              src="https://form.typeform.com/to/L2CWO0b2"
              width="100%"
              height="600"
              frameBorder="0"
              allow="camera; microphone; autoplay; encrypted-media;"
              title="Typeform Trial Request"
              style={{ borderRadius: '16px', width: '100%', height: '100%' }}
              onLoad={e => {
                // Listen for Typeform postMessage event
